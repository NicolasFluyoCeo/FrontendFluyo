    ...
    <section id="about-us" className="py-16 md:py-24">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <FadeIn>
            <div>
              <h3 className="text-xl text-amber-600 mb-4">¿Qué es Fluyo y cómo transforma el proceso?</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <StaggerItem>
                ...
                >
                  ...
                  <p>Consulta y postula a licitaciones de forma intuitiva.</p>
                </motion.div>
              </StaggerItem>
              ...
              <StaggerItem>
                ...
                >
                  ...
                  <p>Accede a información veraz y actualizada en un solo lugar.</p>
                </motion.div>
              </StaggerItem>
              ...
              <StaggerItem>
                ...
                >
                  ...
                  <p>Soporte personalizado para navegar en el sistema de contrataciones.</p>
                </motion.div>
              </StaggerItem>
              ...
              <StaggerItem>
                ...
                >
                  ...
                  <p>Procesos claros y confiables para combatir la corrupción.</p>
                </motion.div>
              </StaggerItem>
            </div>
          </StaggerChildren>
